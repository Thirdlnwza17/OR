      ...
      <header className="sticky top-0 left-0 right-0 z-50 w-full bg-white/95 backdrop-blur-lg shadow-lg border-b border-blue-100">
        <div className="w-full px-4 sm:px-6 py-3">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="hidden sm:flex flex-col items-center justify-center bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl px-6 py-3 shadow-inner border border-blue-100">
              <div className="text-2xl md:text-3xl font-mono font-bold text-blue-800 tracking-wider tabular-nums">
                {timeStr}
              </div>
              <div className="text-xs md:text-sm text-gray-600 font-medium mt-1 text-center leading-tight">
                {currentDate}
              </div>
            </div>
            ...
            <div className="sm:hidden flex flex-col items-center">
              <div className="text-lg font-mono font-bold text-blue-800 tracking-wide tabular-nums">
                {timeStr}
              </div>
